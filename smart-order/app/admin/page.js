...
const STATUS_LABEL = {
  ...
  selesai:    { label: "Selesai",   color: "#4ade80", bg: "rgba(74,222,128,0.08)",   border: "rgba(74,222,128,0.2)" },
            ...
            >
              ...
              >
                ...
                <span style={{
                  ...
                  border: `1px solid ${hasService ? "rgba(74,222,128,0.2)" : "rgba(96,165,250,0.2)"}`,
                  flexShrink: 0,
                }}>
                            ...
                            {nextStatuses.map((s) => (
                              <button
                                ...
                                style={{
                                  ...
                                  borderColor: s === "dibatalkan" ? "rgba(248,113,113,0.25)" : "rgba(74,222,128,0.25)",
                                }}
                              >
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginBottom: "8px" }}>
                              {offers.map((offer) => (
                                <div key={offer.id} style={{
                                  ...
                                  borderRadius: "var(--radius-sm)",
                                  border: `1px solid ${
                                    offer.status === "accepted" ? "rgba(74,222,128,0.3)" :
                                    ...
                                    <div style={{ display: "flex", gap: "6px", marginTop: "8px" }}>
                                      <button
                                        ...
                                        style={{
                                          ...
                                          border: "1px solid rgba(74,222,128,0.25)", borderRadius: "var(--radius-sm)",
                                          cursor: "pointer",
                                        }}
                                      >
          ...
          >
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "3px" }}>
                ...
                <span style={{ fontSize: "10px", fontWeight: 500, padding: "2px 7px", borderRadius: "4px", background: item.type === "product" ? "var(--blue-subtle)" : "var(--accent-subtle)", color: item.type === "product" ? "var(--blue)" : "var(--accent)", border: `1px solid ${item.type === "product" ? "rgba(96,165,250,0.2)" : "rgba(74,222,128,0.2)"}`, flexShrink: 0 }}>
                  {item.type === "product" ? "Produk" : "Layanan"}
                </span>
              </div>
              <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "12px", fontWeight: 600, color: "var(--text-primary)", flexShrink: 0 }}>Rp {item.price.toLocaleString("id-ID")}</span>
              </div>
            </div>
